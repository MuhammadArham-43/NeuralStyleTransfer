...
from utils import img_loader, train, imshow, postprocess
...
if __name__ == "__main__":
    ...
    STYLE_IMG_PATH = 'images/styleImg.jpg'
    CONTENT_IMG_PATH = 'images/contentImg.jpg'
    ...
    model, style_losses, content_losses = vgg.build_model(content_img=content_img, style_img=style_img)
    ...
    result = Image.fromarray(postprocess(np.asarray(result), mask_img))
